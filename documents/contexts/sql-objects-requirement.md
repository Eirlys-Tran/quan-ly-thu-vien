...
4.	Giới hạn số lượng sách mượn: Ngăn không cho một độc giả mượn thêm sách nếu tổng số sách họ đang mượn (trạng thái 'Đang mượn') cộng với số sách trong lần mượn mới vượt quá 5 cuốn.
